...
function ItemDetail({item,onClose,onAddToOutfit,showToast,onRemove,onUpdate}){
  ...
  const [editImage,setEditImage]=useState(null); // base64 or url
  const imgRef=useRef();
  ...
  const saveEdit=()=>{
    const updated={
      ...
      purchaseDate: editDate.trim()||item.purchaseDate,
        ...
        {editing ? (
          <>
            ...
            <div style={{marginBottom:20}}>
              <div style={ss(9,400,DM,{letterSpacing:1.5,marginBottom:6})}>DATE PURCHASED</div>
              <input value={editDate} onChange={e=>setEditDate(e.target.value)} style={inputStyle} placeholder="e.g. Jan 2024"/>
            </div>
